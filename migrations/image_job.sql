...
CREATE TABLE IF NOT EXISTS public.image_jobs (
  ...
  input_image_url TEXT, -- input image URL (renamed from input_image)
  image_gen_url TEXT, -- generated image URL (renamed from generated_image_url)
  image_analysis JSONB, -- analysis of the input image (changed to JSONB)
